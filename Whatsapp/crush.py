...
whatsapp_number = "6281212471448"
pesan_aku = "I want, now we are dating"
...
def buka_whatsapp():
    encoded_message = urllib.parse.quote(pesan_aku)
    webbrowser.open_new("https://api.whatsapp.com/send?phone={whatsapp_number}&text=aku juga suka sama kakak")
